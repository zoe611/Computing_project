...
public class BaseNetworkAccess {
    ...
    private String HOST_PUBMED = "www.ncbi.nlm.nih.gov/pubmed";
   

    private String TOOL = "SRI_metadata_extraction";
    private String EMAIL = "junwenz@unimelb.edu.au";
    ...
    public URI buildDetailRequestURI(String id) throws URISyntaxException {
        return new URIBuilder()
                .setScheme(SCHEME)
                .setHost(HOST_PUBMED)
                .setPath("/"+id)
                .setParameter("report", "medline")
                .setParameter("format","text")
                .build();
    }
